 ...
 * @author Man-gel
 */
public class ResultSetTablaModelo extends AbstractTableModel{
    ...
    public ResultSetTablaModelo(String url, String user, String pass, String query) throws SQLException
    {
